              ...
              <div className="site-card" style={{ padding: 32 }}>
                <div className="site-card-content">
                  <p>
                    ...
                    2015 — est un régime simplifié de création
                    d&apos;entreprise. Il est particulièrement adapté aux
                    indépendants, freelances, artisans et professions libérales
                    qui souhaitent lancer leur activité avec un minimum de
                    contraintes administratives.
                  </p>
                  <p>
                    Ce statut offre plusieurs avantages : déclaration simplifiée
                    du chiffre d&apos;affaires, cotisations sociales
                    proportionnelles à l&apos;activité, franchise en base de TVA
                    (sous certains seuils) et comptabilité allégée. Cependant,
                    il ne dispense pas d&apos;obligations essentielles,
            ...
            <div className="site-feature-grid">
              <div className="site-card" style={{ padding: 24 }}>
                ...
                <p className="site-card-desc">
                  Toute prestation supérieure à 25 € TTC (1 € pour les ventes de
                  biens) doit faire l&apos;objet d&apos;une facture. Cette
                  obligation concerne les transactions avec des professionnels
                  comme avec des particuliers.
                </p>
              </div>
              ...
              <div className="site-card" style={{ padding: 24 }}>
                ...
                <p className="site-card-desc">
                  La loi impose la sécurisation des factures pour lutter contre
                  la fraude. Le Factur-X (PDF + XML) est le format recommandé.
                  Même en franchise de TVA, anticiper cette obligation est un
          ...
          <Reveal>
            <div className="site-section-head site-section-head--centered">
              ...
              <p className="site-lead site-section-head-desc">
                ...
                Pas besoin d&apos;expertise comptable — l&apos;outil
                s&apos;occupe de tout.
              </p>
            </div>
          </Reveal>
            ...
            <div className="site-feature-grid-lg">
              {ADVANTAGES.map((a) => (
                <div
                  ...
                  style={{ padding: 28 }}
                >
                  <div className="site-card-icon-blue">{a.icon}</div>
                ...
                <div className="site-card-content">
                  ...
                  <p>
                    <strong style={{ color: "var(--text)" }}>
                      XOpus élimine ces risques.
                    </strong>{" "}
                    Chaque facture générée est automatiquement conforme à la
                  ...
                  >
                    ...
                    >
                      ...
                      <span>
                        ...
                        — chaque facture reçoit un numéro unique et
                        chronologique
                      </span>
                    </li>
                    <li
                    ...
                    >
                      ...
                      <span>
                        ...
                        — franchise en base ou régime réel, XOpus détecte et
                        affiche la mention correcte
                      </span>
                    </li>
                    <li
                      style={{
                    ...
                    >
                      ...
                      <span>
                        ...
                        — format hybride PDF + XML conforme à la norme EN 16931
                      </span>
                    </li>
                    <li
                      style={{
                    ...
                    >
                      ...
                      <span>
                        ...
                        — chaque facture est horodatée pour preuve en cas de
                        contrôle
                      </span>
                    </li>
                    <li
                    ...
                    >
                      ...
                      <span>
                        ...
                        — vos factures sont conservées 10 ans, conformément à la
                        réglementation
                      </span>
                    </li>
                  </ul>
        ...
        <section className="site-section">
          <Reveal>
            <div className="site-section-head site-section-head--centered">
              ...
              <h2 className="site-section-title">
                Ils utilisent <span className="site-title-accent">XOpus.</span>
              </h2>
            </div>
          </Reveal>
        ...
        <section className="site-section">
          <Reveal>
            <div className="site-centered-block">
              ...
              >
                Pourquoi <span className="site-title-accent">XOpus</span> est le
                meilleur choix pour les auto-entrepreneurs
              </h2>
              <div className="site-card-content">
                <p>
                  L&apos;auto-entrepreneur fait face à un paradoxe : il
                  bénéficie d&apos;un statut simplifié, mais ses obligations de
                  facturation sont aussi strictes que celles d&apos;une société
                  classique. La loi PACTE de 2019, le durcissement de la lutte
                  contre la fraude TVA et l&apos;obligation progressive du
                  Factur-X ont considérablement renforcé ces exigences.
                </p>
                <p>
                  Les solutions existantes ne répondent pas toujours aux besoins
                  spécifiques des micro-entreprises. Les logiciels grand public
                  sont souvent trop complexes ou trop chers. Les outils gratuits
                  manquent de fonctionnalités essentielles comme le Factur-X ou
                  l&apos;espace client. XOpus a été conçu pour combler ce vide.
                </p>
                <p>
                  Avec un tarif de 9,99 €/mois — le plus bas du marché pour un
                  outil aussi complet — XOpus est accessible même aux
                  auto-entrepreneurs qui démarrent. L&apos;essai gratuit de 14
                  jours permet de tester toutes les fonctionnalités sans
                  engagement, sans carte bancaire.
                </p>
                <p>
                  Au-delà de la facturation, XOpus offre un écosystème pensé
                  pour l&apos;indépendant : espace client pour le suivi des
                  devis et factures, paiements en ligne via Stripe, relances
                  automatiques pour améliorer le recouvrement, et un tableau de
                  bord pour visualiser l&apos;activité en temps réel. C&apos;est
                  bien plus qu&apos;un outil de facturation — c&apos;est un
